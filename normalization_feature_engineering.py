...
# Part 1: Normalization (Database Ready Data Types) 
print("\nRunning normalization on data types...")

# Cast float identifiers and counts to smaller integers to save space
...
# Cast Location IDs to 32-bit integers
df['PULocationID'] = df['PULocationID'].astype('int32')
df['DOLocationID'] = df['DOLocationID'].astype('int32')

# Cast high-cardinality string flags to categorical type
...
# Part 2: Feature Engineering (Three Derived Features)
print("\nRunning feature engineering...")

# Feature 1: Trip Duration in minutes
# Justification: Helps analyze speed and travel times across different zones.
